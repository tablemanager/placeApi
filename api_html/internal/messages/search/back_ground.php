...
require_once ('/home/ubuntu/sparo.cc/api_html/internal/messages/lib/sms_lib.php');
/*
$ip = get_ip();
if ($ip != "106.254.252.100" && $ip != "118.131.208.123" && $ip != "115.89.22.27"  && $ip != "218.39.39.190" && $ip != "115.92.242.18" && $ip != "115.92.242.187" && $ip != "1.223.90.211") {
...
// 단, IDX 가 들어오면 IDX만!!!!!!!!!!!!!!!!!!!!!!!
if (isset($data['$data'])&& ($data['IDX'] != '')){
	$sql_array[] = "`IDX` = '".$data['IDX']."'";
} else {
