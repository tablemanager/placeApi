...
//	$_data = $connSparo2->get_phoenix_pkglist($data['itemid']);
	...
	foreach ($connSparo2->get_phoenix_pkglist($data['itemid']) as $row){
		...
		if($row['stdGoodselect'] == null){
            ...
            //'sellClientCd'=>$clientList[0]->sellClientCd,     //판매거래처코드	sellClientCd	10	String		Y
			$fields = array(
                ...
                'sellClientSellNo'=>$data['ch_orderno'],      //판매거래처판매번호  sellClientSellNo    40  String      Y   대매사주문번호
