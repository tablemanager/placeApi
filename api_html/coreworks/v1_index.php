...
require_once ('/home/sparo.cc/coreworks_script/lib/lib_coreworks.php'); // 코어웍스 관련 상수 정의
...
switch ($para){
    ...
    case 'cancel':
        // var_dump($jsonreq);
        $response = sendCancelOrder($jsonreq);
        // echo $response;
...
function sendCancelOrder($json){
    $curl = curl_init();
	// apiurl = DEVURL_ORDER / PRODUCT_ORDER
	// authorization key = DEVKEY / PRODUCTKEY
    curl_setopt_array($curl, array(
    CURLOPT_URL => PRODUCT_CANCEL,
