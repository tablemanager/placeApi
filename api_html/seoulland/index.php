<?php
/*
* brief 서울랜드(스마트인피니) 주문 취소를 위한 내부인터페이스(스마트인피니 취소api를 통해 핀폐기 처리)
*
* author Jason
* date 22.03.14
*/
...
require_once ('/home/sparo.cc/seoulland_script/lib/SeoullandApi.php');

header("Content-type:application/json");

$db = new SeoullandDB();
$api = new SeoullandApi(); // 본서버(라이브서버) api
...
if($code == "0000"){
    ...
    $cancelRes = $db->cancelSeoullandPin($orderSales);
