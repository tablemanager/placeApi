...
// 가능 판매채널 코드
$charr = array(242,3327,3463,3584,3088,218,3467,3590,211,3605,3610,3615,3619,238,3631,4012,4014,3632,3633,3634,3638,3324,3135,3481,3653);
	...
	$cntsql = "SELECT sum(man1) as usecnt 
		...
		// 주문 리스트(메인)
 			$orderqry = "SELECT o. * ,AES_DECRYPT(UNHEX(o.hp),'Wow1daY') dhp 
								 ...
								 AND usegu_at between '$sdate' and '$edate'   
								 AND usegu = '1' 
								 AND state= '예약완료' order by updated asc ";
