...
// 20241024 tony DT 사용처리 API 업체코드 참조 처리 https://placem.atlassian.net/browse/P2D-7
// 업체코드로 사용처리 API 호출 제한
...
// 20241024 tony DT 사용처리 API 업체코드 참조 처리 https://placem.atlassian.net/browse/P2D-7
// 대리점(시설)이면서 사용상태가 Y인 업체코드 조회
$fsql = "select * from CMSDB.CMS_COMPANY where com_type = 'S' and com_state = 'Y'";
$fres = $conn_cms->query($fsql);
